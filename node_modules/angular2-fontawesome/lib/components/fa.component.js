...
let FaComponent_1;
let FaComponent = FaComponent_1 = class FaComponent {
    constructor(el) {
        this.classList = ['fa'];
    }
    ngOnChanges(changes) {
        for (var key in changes) {
            ...
            switch (key) {
                ...
                case 'alt':
                    break;
                case 'size':
                    if (FaComponent_1.sizeValidator.test(currentValue)) {
                        if (previousValue === 1) {
    ...
    addFaClass(className) {
        this.classList.push(className);
    }
    removeFaClass(className) {
        var index;
...
FaComponent = FaComponent_1 = __decorate([
    core_1.Component({
        selector: 'fa',
